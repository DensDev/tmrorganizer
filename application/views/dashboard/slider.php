...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <a href=<?php echo site_url()."slider/create" ?> class="btn btn-primary">Add Image</a>
                <br><br>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <img src= "<?php echo base_url('assets/admin/slider/'.$image->filefoto); ?>" alt="<?php echo $image->nama_file; ?>" width="300" height="300" />
                  </div>
                  <div class="col-md-4">
                    <h3><?php echo $image->nama_file; ?></h3>
                    <br>
                    <a href="<?php echo base_url('slider/edit/'.$image->id); ?>" class="btn btn-warning">Edit</a>
                    <?php
                    $hapus = array(
                        'class' => 'btn btn-danger',
                        'onclick' => 'javascript: return confirm(\'Anda yakin menghapus ' . $image->nama_file . '?\')'
                    );
                    echo anchor(site_url('slider/delete/' . $image->id), 'Hapus', $hapus);
                    ?>
                  </div>
                </div>
                <hr>
